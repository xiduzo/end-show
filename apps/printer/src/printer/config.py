...
# ble = Bluetooth Low Energy (4.0): dual-mode units (e.g. M58-LL) whose Classic
# SPP port connects but never prints — the engine only reads the BLE channel.
